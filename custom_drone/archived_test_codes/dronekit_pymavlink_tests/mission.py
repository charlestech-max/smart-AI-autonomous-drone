...
def adds_square_mission(cur_location, waypoints):
    ...
    for i in range(1,len(waypoints)):
        ...
        print(point)
        cmds.add(Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 0, point.lat, point.lon, 35))
    cmds.add(Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 0, point.lat, point.lon, 35))
...
#def run_mission():
    print("Enter l,b,distance and alt ")
    l, b , dist, alti= [int(x) for x in input().split()]
    #l = 100
    #b = 100
    #dist = 20
    ...
    vehicle.parameters['FENCE_RADIUS'] = 300
    vehicle.parameters['FENCE_ACTION'] = 0
    vehicle.parameters['FENCE_ALT_MAX'] = 50
    vehicle.parameters['RTL_ALT'] = 1000
    vehicle.parameters['RTL_SPEED'] = 200
    #vehicle.parameters['PILOT_TKOFF_ALT'] = 500
